  ...
  return (
    <footer>
      <div className="mx-auto container space-y-8 px-4 py-16">
          ...
          <div className="grid grid-cols-1 gap-8 sm:grid-cols-2 lg:col-span-2 lg:grid-cols-4">
            <div>
              ...
              <ul className="mt-6 space-y-4 text-sm">
                {["1on1 Coaching", "Company Review", "Accounts Review", "HR Consulting", "SEO Optimisation"].map((item) => (
                  <li key={item}>
                    <a href="#" className="text-muted-foreground/80 transition hover:opacity-75">{item}</a>
                  </li>
                ))}
              </ul>
            </div>
            ...
            <div>
              ...
              <ul className="mt-6 space-y-4 text-sm">
                {["Accessibility", "Returns Policy", "Refund Policy", "Hiring Statistics"].map((item) => (
                  <li key={item}>
                    <a href="#" className="text-muted-foreground/80 transition hover:opacity-75">{item}</a>
                  </li>
                ))}
        ...
        <p className="text-xs text-muted-foreground/80">© 2022. Company Name. All rights reserved.</p>
      </div>
    </footer>
  );
}